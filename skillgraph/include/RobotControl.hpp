...
class RobotControl
{
    ...
    /* -------------------------------------------------------------------------- */
    public:
        typedef std::shared_ptr<RobotControl> Ptr;
        typedef std::shared_ptr<RobotControl const> ConstPtr;
    ...
    private:
        ...
        Eigen::MatrixXd Ac_;
        Eigen::MatrixXd Bc_;
        lego_manipulation::math::Capsule cap_[6];
        lego_manipulation::math::Capsule cap_cur_[6];
        Eigen::MatrixXd M_[8];
        ...
        int nlink_human_ = 6;
        lego_manipulation::math::Capsule human_cap_[6];

        // Capsules size = 1 (base) + n_joint + 1 (ee)
        std::vector<lego_manipulation::math::Capsule> capsules_;
